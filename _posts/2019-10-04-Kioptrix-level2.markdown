...
<img src="/assets/images/Kioptrix/Kioptrix2-loginprompt.png" width="100%">
<br><br>
...
Using <font color="red">wget</font>, the exploit is downloaded from an external HTTP server that i setup. The exploit is
